                ...
                <div class="row">
                    <div class="col-sm-12 col-md-3 col-lg-3">
                        ...
                        <ul role="tablist" class="nav flex-column dashboard-list">
                            ...
                            <li> <a href="thong-tin-ca-nhan/feedback" class="nav-link active">Đánh giá sản phẩm</a></li>
                                                ...
                                                @foreach ($orders as $order)
                                                    @if ($order->status == 'Đã giao hàng')
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @foreach ($order->orderDetails as $orderDetail)
                                                                    {{ number_format($orderDetail->product->price) }}đ
                                                                    <br>
                                                                @endforeach
                                                            </td>
                                                            ...
                                                            <td>
                                                                ...
                                                                @foreach ($order->orderDetails as $orderDetail)
                                                                    @php
                                                                        ...
                                                                        // Break the loop if any product has been reviewed
                                                                        if ($hasReview) {
                                                                            break;
                                                                        }
                                                                    @endphp
                                                                ...
                                                                @if (!$hasReview)
                                                                    @foreach ($order->orderDetails as $orderDetail)
                                                                        <a
                                                                            href="{{ route('reviews.show', ['productId' => $orderDetail->product_id, 'orderId' => $order->id]) }}">
                                                                            Đánh giá
                                                                        </a>
                                                                        <br>
                                                                    @endforeach
