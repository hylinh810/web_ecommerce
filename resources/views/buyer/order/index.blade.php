                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        @endif
                        <td>
                          <a href="buyer/edit-order/{{ $order->id }}"><i class=" fas fa-pen"></i></a>
                            
                          <a href="buyer/show-order/{{ $order->id }}"><i style="margin-left: 20px" class="fas fa-eye"></i></a>
                            @if($order->status == 'Đã giao hàng')
                            <a href="buyer/remove-order/{{ $order->id }}"><i class=" fas fa-trash" style="margin-left: 20px"></i></a>
                            @endif
                        </td>
                    </tr>
                    @endforeach
