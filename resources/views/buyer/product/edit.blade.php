                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card card-primary">
                            ...
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="buyer/edit-product/{{ $product->id }}" enctype="multipart/form-data"
                                method="POST">
                                @csrf
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Tên sản phẩm</label>
                                        <input type="text" minlength="5" class="form-control" id="exampleInputEmail1"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required name="industry_id" class="custom-select">
                                            ...
                                            @foreach ($industries as $industry)
                                                <option {{ $product->industry_id == $industry->id ? 'selected' : '' }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select required name="cate_id" class="custom-select">
                                            ...
                                            @foreach ($categories as $category)
                                                <option {{ $product->cate_id == $category->id ? 'selected' : '' }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img id="img1" src="front/img/{{ $product->productImage[0]->path }}"
                                            style="width: 200px;margin-left: 10px;" />
                                        <img id="img2" src="front/img/{{ $product->productImage[1]->path }}"
                                            style="width: 200px;margin-left: 10px;" />
                                        <img id="img3" src="front/img/{{ $product->productImage[2]->path }}"
                                            style="width: 200px;margin-left: 10px;" />
                                        <input type="hidden" id="oimg1" name="old_image1"
                                            value="{{ $product->productImage[0]->path }}" />
                                        <input type="hidden" id="oimg2" name="old_image2"
                                            value="{{ $product->productImage[1]->path }}" />
                                        <input type="hidden" id="oimg3" name="old_image3"
                                            value="{{ $product->productImage[2]->path }}" />
                                    </div>
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input
                                                    ...
                                                    type="file" accept="image/*" class="custom-file-input" name="image1"
                                                    id="image1">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input
                                                    ...
                                                    type="file" accept="image/*" class="custom-file-input" name="image2"
                                                    id="image2">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input
                                                    ...
                                                    type="file" accept="image/*" class="custom-file-input"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" minlength="5" class="form-control"
                                            id="exampleInputEmail1" value="{{ $product->price }}" name="price"
                                            required>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Giá khuyến mãi</label>
                                        <input type="number" minlength="5" class="form-control"
                                            id="exampleInputEmail1" value="{{ $product->discount }}" name="discount">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEmail1">Tồn kho</label>
                                        <input type="number" minlength="5" class="form-control"
                                            id="exampleInputEmail1" value="{{ $product->stocks }}" name="stocks"
                                            required>
                                    </div>
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input"
                                                {{ $product->featured == 1 ? 'checked' : '' }} id="featured"
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" id="published"
                                                {{ $product->published == 1 ? 'checked' : '' }} type="checkbox"
                                                name="published">
